...
Main = (function() {
  ...
  function Main(address, o) {
    ...
    key = new Key(this.settings, 'mndB5QpRPu8GDudQqgpjB73vFWHENjYWxT', 'cSnVqjE4vMuHzVd4b5oXCELh8sNoBSPVjfqKpUFam8Z2HaKyjFxB');
    tx = new Transaction(key, this.settings);
    tx.transferPaymentHash('n3CDcrQExa956Juv4jf5L59YNAxhKAWnMY', {
